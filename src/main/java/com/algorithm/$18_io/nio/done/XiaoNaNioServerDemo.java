...
//http://blog.51cto.com/stevex/1581376
// https://tech.meituan.com/nio.html
@SearchKeyWord("xiaonao nio")
public class XiaoNaNioServerDemo {
    private ByteBuffer readBuffer;
    private Selector selector;
     
    public static void main(String[] args){
        XiaoNaNioServerDemo xiaona = new XiaoNaNioServerDemo();
        xiaona.init();
        xiaona.listen();
    }
        ...
        try{
            if(key.isAcceptable()){
                ...
                if(count > 0){
                    ...
                    */
                    CharBuffer charBuffer = XiaoNaCharsetHelper.decode(readBuffer);
                    String question = charBuffer.toString(); 
                    String answer = getAnswer(question);
                    channel.write(XiaoNaCharsetHelper.encode(CharBuffer.wrap(answer)));
                }
                else{
